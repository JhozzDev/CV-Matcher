...
Despliegue de la interfaz web con "Streamlit run [app_name].py"

Subir Curriculum vitae con formato pdf.
...
Scikit-learn: Procesamiento de lenguaje natural con TF-DFT para analizar la cercania entre el CV y las decripciones laborales.

Pandas: Para la lectura de los datos y el manejo de dataframes dentro del programa.
